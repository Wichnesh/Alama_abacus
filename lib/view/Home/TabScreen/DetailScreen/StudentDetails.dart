...
import '../../../../controller/StudentDetail_controller.dart';
...
class StudentDetails extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final admin = Prefs.getBoolen(SHARED_ADMIN);
    return Scaffold(
      appBar: AppBar(
          ...
          Row(
            ...
            children: [
              admin
                  ? Obx(() => IconButton(
                        onPressed: () {
                          Get.find<HomeController>().isStudentEdit.value =
                              !Get.find<HomeController>().isStudentEdit.value;
                        },
                        icon: Icon(
                            Get.find<HomeController>().isStudentEdit.value
      ...
      body: SingleChildScrollView(
        child: Obx((){
          if(controller.isLoading.value){
            ...
            var data = controller.studentDetail!;
            return Column(
              children: [
                Padding(
                ...
                Padding(
                  ...
                  child: TextField(
                    ...
                    onChanged: (value) => Get.find<StudentController>()
                        .updateStudentData['enrollDate'] = value,
                  ),
                ),
                Padding(
                  padding: const EdgeInsets.all(16.0),
                  child: TextField(
                    decoration: InputDecoration(
                      ...
                      border: Get.find<HomeController>().isStudentEdit.value
                    ...
                    onChanged: (value) => Get.find<StudentController>()
                        .updateStudentData['franchise'] = value,
                  ),
                ),
                Padding(
                  padding: const EdgeInsets.all(16.0),
                  child: TextField(
                    ...
                    readOnly: !Get.find<HomeController>().isStudentEdit.value,
                    onChanged: (value) => Get.find<StudentController>()
                        .updateStudentData['studentName'] = value,
                  ),
                ),
                Padding(
                  padding: const EdgeInsets.all(16.0),
                ...
                Padding(
                  ...
                  child: TextField(
                    ...
                    readOnly: !Get.find<HomeController>().isStudentEdit.value,
                    onChanged: (value) => Get.find<StudentController>()
                        .updateStudentData['mobileNumber'] = value,
                  ),
                ),
                Padding(
                  padding: const EdgeInsets.all(16.0),
                ...
                Padding(
                  ...
                  child: TextField(
                    ...
                    readOnly: !Get.find<HomeController>().isStudentEdit.value,
                    onChanged: (value) => Get.find<StudentController>()
                        .updateStudentData['district'] = value,
                  ),
                ),
                Padding(
                  padding: const EdgeInsets.all(16.0),
                ...
                Padding(
                  ...
                  child: TextField(
                    ...
                    true, //!Get.find<HomeController>().isStudentEdit.value,
                    onChanged: (value) => Get.find<StudentController>()
                        .updateStudentData['program'] = value,
                  ),
                ),
                ElevatedButton(
                  onPressed: () {
                                  ...
                                  onPressed: () {
                                    ...
                                    if (controller.currentlevel.value ==
                                      ...
                                      if (!controller
                                        ...
                                        controller.isDataInitialized =
                                        true;
                                      }
                                      controller.tell();
                                    } else {
                                      // Increment the level
                                      int nextLevel = int.parse(
                                          controller
                                              .currentlevel.value
                                              .split(' ')[1]) +
                                          1;
                          ...
                          admin ?  Expanded(
                              child: SizedBox(
                                ...
                                child: Obx(() => ElevatedButton(
                                  ...
                                  onPressed: Get.find<StudentController>()
                                      .isLoading
                                      .value
                                      ? null
                                      : () async {
